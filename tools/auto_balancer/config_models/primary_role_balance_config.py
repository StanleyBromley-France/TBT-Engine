...
class PrimaryRoleBalanceConfig:
    target_primary_role: str
    unit_max_hp_min: int
    unit_max_hp_max: int
    ...
    primary_role_alignment_fitness_weight: float


@dataclass(frozen=True)
class PrimaryRoleBalancerConfig:
    scenario: ScenarioConfig
    ga: GaConfig
    balance: PrimaryRoleBalanceConfig
